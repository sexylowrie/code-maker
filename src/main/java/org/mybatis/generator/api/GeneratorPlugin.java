...
public class GeneratorPlugin extends PluginAdapter {
    ...
    private String  BASE_ENTITY = "xin.sunce.common.entity.BaseEntity";
    private String  BASE_DAO = "xin.sunce.common.dao.BaseDao";
    private String  BASE_SERVICE = "xin.sunce.common.service.BaseService";
    private String  BASE_CONTROLLER = "xin.sunce.common.web.BaseController";
    private String  PACKAGE_DAO = "xin.sunce.customer.dao";
    private String  PACKAGE_ENTITY = "xin.sunce.customer.entity";
    private String  PACKAGE_SERVICE = "xin.sunce.customer.service";
    private String  PACKAGE_CONTROLLER = "xin.sunce.customer.web";
    /**
     * 生成dao
     */
	@Override
